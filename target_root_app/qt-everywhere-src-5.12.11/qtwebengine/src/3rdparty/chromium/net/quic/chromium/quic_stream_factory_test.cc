...
TEST_P(QuicStreamFactoryTest, MigrateToProbingSocket) {
  ...
  quic_data2.AddRead(
      SYNCHRONOUS, server_maker_.MakeConnectivityProbingPacket(2, false, 1338));
  quic_data2.AddRead(
      SYNCHRONOUS, server_maker_.MakeConnectivityProbingPacket(3, false, 1338));
  quic_data2.AddRead(
      SYNCHRONOUS, server_maker_.MakeConnectivityProbingPacket(4, false, 1338));
  quic_data2.AddWrite(
