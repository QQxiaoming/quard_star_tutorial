...
SOH         = 0x01.to_bytes(1, 'little')
STX         = 0x02.to_bytes(1, 'little')
EOT         = 0x04.to_bytes(1, 'little')
ACK         = 0x06.to_bytes(1, 'little')
XON         = 0x11.to_bytes(1, 'little')
XOFF        = 0x13.to_bytes(1, 'little')
NAK         = 0x15.to_bytes(1, 'little')
CAN         = 0x18.to_bytes(1, 'little')
CRC         = 0x43.to_bytes(1, 'little')
